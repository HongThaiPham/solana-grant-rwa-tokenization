...
export type InitializeInstruction<
  ...
  TAccountSinger extends string | IAccountMeta<string> = string,
...
> = IInstruction<TProgram> &
  ...
  IInstructionWithAccounts<
    [
      TAccountSinger extends string
        ? WritableSignerAccount<TAccountSinger> &
            IAccountSignerMeta<TAccountSinger>
        : TAccountSinger,
...
export type InitializeAsyncInput<
  TAccountSinger extends string = string,
  TAccountConfigAccount extends string = string,
  TAccountSystemProgram extends string = string,
> = {
  singer: TransactionSigner<TAccountSinger>;
...
> {
  ...
  const originalAccounts = {
    singer: { value: input.singer ?? null, isWritable: true },
  ...
  const instruction = {
    accounts: [
      getAccountMeta(accounts.singer),
